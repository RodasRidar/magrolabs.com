...
export class LandingComponent {
  ...
  private loadSEO() {
    ...
    const organizationSchema = {
      ...
      description:
        "Líder en suplementos deportivos de alta calidad en Perú. Especialistas en creatina monohidrato premium.",
      contactPoint: {
        "@type": "ContactPoint",
    ...
    const productSchema = {
      ...
      description:
        "Creatina 100% monohidratada, ideal para aumentar fuerza y masa muscular. Primera entrega gratuita.",
    ...
    const faqSchema = {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: this.ENV.campanaPrimeraCreatina.textos.faqRespuestaRecepcion(
              this.ENV.plazoDeEntregaHorasCreatinaFree.min,
              this.ENV.plazoDeEntregaHorasCreatinaFree.max,
            ),
          },
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              this.ENV.campanaPrimeraCreatina.tipo === "gratis"
