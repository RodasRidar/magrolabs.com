...
export class PagoComponent {
  ...
  list = [
    ...
    },
    {
      ...
      description: 'Solo puedes parar los pagos automáticos pausando o cancelando tu suscripción. Esto lo puedes hacer fácilmente tú mismo en tu cuenta en la página "Suscripciones". Al verificar tus datos de pago, aceptaste el cobro mensual. Si quieres cancelar tu suscripción y no recibir una próxima entrega, deberias hacerlo '+this.ENV.diasAntesDeSiguienteCobroSubscripcion +' días antes de tu fecha de facturación.',
    },
    {
      title: 'No he recibido aún mi creatina gratis, y ya se ha realizado un cobro.',
      description: 'Tu creatina gratuita se envió inmediatamente después de completar tu registro. Te enviamos un correo electrónico sobre la finalización de tu período de reflexión de '+this.ENV.diasNormalesDePruebaOperiodoDeReflexion +' días. Tu suscripción ha comenzado y ahora está activa. Después del período de reflexión, realizaremos cobros mensuales en tu fecha de facturación que es la misma del inicio de tu suscripción. La entrega de ese pedido siempre se hará entre'+ this.ENV.plazoDeEntregaMensualesCreatina.min+' y '+ this.ENV.plazoDeEntregaMensualesCreatina.max+' días despues del cobro'+
    ...
    },
    {
      ...
      description: 'En Magrolabs siempre pagas el mes por adelantado. El cobro mensual siempre se realiza en tu fecha de facturación. Recibirás la entrega mensual entre '+ this.ENV.plazoDeEntregaMensualesCreatina.min+' y '+ this.ENV.plazoDeEntregaMensualesCreatina.max+' días despues del cobro. ¿Crees que te falta un pedido? Puedes verificarlo en "Pedidos" en tu cuenta. Si algo no está bien o tienes alguna pregunta sobre tu entrega, por favor contáctanos.',
    },
    {
