...
export class CalculadoraAguaComponent {
  ...
  private setMetaTags(): void {
    this.titleService.setTitle(
      "Calculadora de Hidratación para Creatina | Magrolabs",
    );

    this.metaService.updateTag({
      name: "description",
      content:
        "Calcula tu consumo diario de agua ideal para maximizar los efectos de la creatina monohidratada. Hidratación óptima para mejor rendimiento deportivo.",
    });
    ...
    this.metaService.updateTag({
      ...
      content:
        "Descubre cuánta agua necesitas consumir diariamente para optimizar los efectos de la creatina monohidratada.",
    });
