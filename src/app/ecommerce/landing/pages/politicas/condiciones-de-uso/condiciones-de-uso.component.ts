  ...
  list = [
    ...
    },
    {
      ...
      description:[
        ...
        '2.5. Oferta. ON THAT ASS determinará a su discreción si alguien es elegible para el período de reflexión y puede limitar las condiciones o la duración para evitar abusos. Nos reservamos el derecho de cobrar por varios bóxers o conjuntos gratis obtenidos por cuenta.',
        ...
        '2.7. Plazo de cancelación. La suscripción a ON THAT ASS se renueva automáticamente después de tu período de reflexión de 14 días. Durante el período de reflexión de 14 días, puedes cancelar el contrato de inmediato. Una vez que tu suscripción esté activa, podrás cancelarla mensualmente.',
      ]
    },
    {
      title: 'Periodo de reflexión',
    ...
    },
    {
      ...
      description:[
        '3.1. Cuotas de suscripción. Las cuotas de suscripción de ON THAT ASS se debitan mensualmente a través del método de pago vinculado al registrarte.',
        '3.2. Débito y entrega. Las cuotas de suscripción de ON THAT ASS se debitan antes de que se entregue el producto correspondiente. El débito se realiza alrededor del día 27 de cada mes, y la entrega se realiza a partir del día 17 del mes siguiente',
        '3.3. Método de pago. Para participar en ON THAT ASS, debes proporcionar un método de pago válido. Puedes consultar o modificar tus medios de pago en tu cuenta, en el menú superior "Datos personales! y luego en el menú lateral "Datos de pago". Para utilizar y vincular algunos métodos de pago, el proveedor puede cobrarte ciertas tasas, como tasas por transacciones internacionales u otras tasas por procesar tus medios de pago. Los impuestos locales pueden variar según los métodos de pago. Para más información, ponte en contacto con el proveedor de tu método de pago.',
        '3.4. Cancelación. Puedes cancelar tu suscripción a ON THAT ASS en cualquier momento en línea a través de tu cuenta creada durante el registro. Después de cancelar, mantienes acceso a tu cuenta de ON THAT ASS, donde puedes reactivar tu membresía. La cancelación se puede realizar en tu cuenta en "Membresías" . Después de cancelar, se enviará automáticamente un correo electrónico de confirmación a la dirección de correo electrónico registrada.',
    ...
    },
    {
      title: 'Descuentos',
      description: [
        '7.1. Edad. Debes tener al menos dieciocho años o ser mayor de edad en tu Provincia, Región o País para convertirte en miembro y unirte a ON THAT ASS.',
        '7.2. El miembro que creó la cuenta de ON THAT ASS y cuyo método de pago se utiliza para las cuotas de suscripción (también llamado el usuario), tiene acceso y control sobre la cuenta de ON THAT ASS. Además, el usuario es responsable de todas las actividades que ocurren a través de la cuenta. Eres responsable de la exactitud de los datos que nos proporcionas con respecto a tu cuenta y de actualizarlos cuando sea necesario. Podemos cancelar o bloquear temporalmente tu cuenta para protegerte a ti, a ON THAT ASS o a nuestros socios contra el robo de identidad u otras actividades fraudulentas.'
      ]
    },
    {
      title: 'Otros',
      description: [
        ...
        '8.4. Modificaciones de las Condiciones de Uso. ON THAT ASS podrá modificar periódicamente las presentes Condiciones de Uso. Te notificaremos al menos 30 días antes de que dichos cambios te apliquen.',
