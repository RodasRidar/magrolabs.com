  ...
  list = [
    ...
    },
    {
      ...
      description: [
        ...
        `La descripción de los productos será lo más precisa posible, pero las imágenes son de carácter referencial. La oferta inicial de la ${this.ENV.campanaPrimeraCreatina.textos.heroOferta} está sujeta a los términos de la membresía y se entrega una sola vez por miembro con las condiciones vigentes al momento del registro.`,
