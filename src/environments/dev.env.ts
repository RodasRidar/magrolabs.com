...
const nroReviews = 6;
const urlApiFlow = 'https://www.sandbox.flow.cl/api';
...
const flowApiUrl = 'https://www.dev-function.magrolabs.com/api/flow/';
const flowUrlReturn = 'https://www.develop.magrolabs.com/registro/confirmacion';
const flowUrlConfirmation = 'https://www.dev-api.magrolabs.com/api/v1/orders/pagos/flow/confirmacion';
...
const apiMagroLabs = 'https://www.dev-api.magrolabs.com/api/v1';
const flowUrlReturnPagoPorAdmin = 'https://www.develop.magrolabs.com/cuenta/pedidos';
const useProxy = false;
const cancelDiscout = 30;
const flowCouponId50PercentDiscount = 873;
const diasReembolsoCreditosLoyaltyWebshop = 14;
const flowUrlConfirmationSubscription = 'https://www.dev-api.magrolabs.com/api/v1/subscriptions/confirm-payment'
