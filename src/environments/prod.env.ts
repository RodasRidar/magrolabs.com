...
const flowApiUrl = 'https://www.function.magrolabs.com/api/flow/';
const flowUrlReturn = 'https://www.magrolabs.com/registro/confirmacion';
const flowUrlConfirmation = 'https://www.api.magrolabs.com/api/v1/orders/pagos/flow/confirmacion';
...
const apiMagroLabs = 'https://www.api.magrolabs.com/api/v1';
const flowUrlReturnPagoPorAdmin = 'https://www.magrolabs.com/cuenta/pedidos';
const useProxy = false;
const cancelDiscout = 30;
const flowCouponId50PercentDiscount = 5104;
const diasReembolsoCreditosLoyaltyWebshop = 14;
const flowUrlConfirmationSubscription = 'https://www.api.magrolabs.com/api/v1/subscriptions/confirm-payment'
